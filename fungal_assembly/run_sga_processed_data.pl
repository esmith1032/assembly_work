...
my $work_dir = '/bigdata/bioinfo/esmit013/fungal_assembly/sga_processed_data';
...
##Scaffolding
##The following BWA steps are done in place of using sga-align, as sga-align does not install with the default 
SGA installation
