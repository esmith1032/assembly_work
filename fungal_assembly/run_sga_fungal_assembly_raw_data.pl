...
my $fq_1 = $work_dir . '/flowcell271_lane5_pair1.fastq';
my $fq_2 = $work_dir . '/flowcell271_lane5_pair3.fastq';

my $run_id = 'fungal_assembly_raw_data';
...
system(qq{/opt/linux/centos/7.x/x86_64/pkgs/sga/0.10.14/bin/sga-bam2de.pl -n $min_pairs --prefix $run_id $cleaned_sam});
system(qq{/opt/linux/centos/7.x/x86_64/pkgs/sga/0.10.14/bin/sga-astat.py -m $min_contig_len $cleaned_bam > $astat});
